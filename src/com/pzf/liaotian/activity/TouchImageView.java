...
public class TouchImageView extends ImageView {
	...
	public TouchImageView(ImageShower imageShower) {
		super(imageShower);
		
		gintama = BitmapFactory.decodeResource(getResources(), R.drawable.xiaohei_big);

		DisplayMetrics dm = new DisplayMetrics();
		imageShower.getWindowManager().getDefaultDisplay().getMetrics(dm);
